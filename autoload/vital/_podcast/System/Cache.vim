...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_podcast#System#Cache#import() abort
  ...
  execute join(['function! vital#_podcast#System#Cache#import() abort', printf("return map({'unregister': '', '_vital_depends': '', 'register': '', 'new': '', '_vital_loaded': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
let s:save_cpo = &cpo
