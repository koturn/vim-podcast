...
if v:version > 703 || v:version == 703 && has('patch1170')
  function! vital#_podcast#Process#import() abort
  ...
  execute join(['function! vital#_podcast#Process#import() abort', printf("return map({'shellescape': '', 'has_vimproc': '', 'system': '', 'iconv': '', 'spawn': '', 'get_last_status': ''}, \"function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
  delfunction s:_SID
endif
" ___vital___
