" ============================================================================
" FILE: backspacefm.vim
" AUTHOR: koturn <jeak.koutan.apple@gmail.com>
" DESCRIPTION: {{{
" Podcast player for Vim.
" This file is a definition of parser for backspace.fm.
...
function! podcast#backspacefm#define() abort
  return s:channel
endfunction

let s:channel = {
      \ 'name': 'backspacefm',
      \ 'url': 'http://feeds.backspace.fm/backspacefm'
      \}
